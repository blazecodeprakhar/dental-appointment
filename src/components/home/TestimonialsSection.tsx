      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          <div className="inline-flex items-center gap-2 bg-card rounded-full px-3 sm:px-4 py-2 shadow-soft mb-4">
            ...
            <span className="text-xs sm:text-sm font-medium text-primary">{t('testimonials.badge')}</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Text */}
              <p className="text-sm sm:text-base text-foreground leading-relaxed mb-4 sm:mb-6 break-words">
                "{testimonial.text}"
              </p>
              ...
              <div className="flex items-center gap-2 sm:gap-3 pt-3 sm:pt-4 border-t border-border">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">{t('testimonials.verified')}</p>
                </div>
              </div>
            </div>
          ))}
